...
ALLOWED_HOSTS = [
    '.victorkachalin.ru',  # Allow domain and subdomains
    '.victorkachalin.ru.',
    'www.victorkachalin.ru'  # Also allow FQDN and subdomains
]
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'context_processors.mymenu.menu',
    'context_processors.footer.footer',
)
