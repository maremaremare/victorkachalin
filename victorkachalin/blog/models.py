...
class Category(MPTTModel):
    ...
    content_choices=(('/poems','стихи'),('/list','записи'),('cats','другие категории'),('/page','отдельная страница'), ('cats','отдельная страница без слага'))
...
class SinglePage(models.Model):
    ...
    slug = models.CharField(max_length=50,unique=True)
    text = models.TextField()
    category = models.ForeignKey(Category, null=True, blank = True, limit_choices_to={'content': '' or '/page' })
