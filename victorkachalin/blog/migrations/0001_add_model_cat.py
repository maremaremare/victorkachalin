...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cat'
        db.create_table(u'blog_cat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['blog.Cat'])),
        ...
        db.send_create_signal(u'blog', ['Cat'])


    def backwards(self, orm):
        # Deleting model 'Cat'
        db.delete_table(u'blog_cat')
