...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewPost.cat'
        db.add_column(u'blog_newpost', 'cat',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Category'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewPost.cat'
        db.delete_column(u'blog_newpost', 'cat_id')
    ...
    models = {
        ...
        u'blog.newpost': {
            ...
            'cat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.Category']", 'null': 'True'}),
